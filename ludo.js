        ...
        switch (p) {
            case 1:
                if (win[2] == 0) {
                    p = 2;
                    dice.style.top = "15%";
                    dice.style.left = "71%"; // Centre horizontalement en haut
                    refreshCoins();
                    break;
                }
            case 2:
                if (win[3] == 0) {
                    p = 3;
                    dice.style.top = "65%"; // Bas de la fenêtre
                    dice.style.left = "71%"; // Centre horizontalement en bas
                    refreshCoins();
                    break;
                }
            case 3:
                if (win[4] == 0) {
                    p = 4;
                    dice.style.top = "65%"; // Bas de la fenêtre
                    dice.style.left = "15%"; // Coin inférieur gauche
                    refreshCoins();
                    break;
                }
            case 4:
                if (win[1] == 0) {
                    p = 1;
                    dice.style.top = "15%";
                    dice.style.left = "15%"; // Coin supérieur gauche
                    refreshCoins();
                } else if (win[2] == 0) {
                    p = 2;
                    dice.style.top = "15%";
